...
%% Fill Color Styles
  ...
  \tikzstyle{QuarksFill} = [fill=yellow!15]
...
%% Element Styles
  ...
  \tikzstyle{GroupLabel} = [font={\sffamily\LARGE}, minimum width=4cm, node distance=3.0cm]
...
%% quarks
 ...
 \node[name=T, right of=C, Quarks] {\NaturalElementTextFormat{+2/3}{173,3$\pm$0,8 GeV}{1/2}{t}{top}};
   \node[name=B, below of=T, Quarks] {\NaturalElementTextFormat{-1/3}{4,1-4,4 GeV}{1/2}{s}{bottom}};
   
   \node[name=EU, below of=D, Empty]{\EmptyNode};
   
   %% leptons
  \node[name=E, below of=EU, Leptons] {\NaturalElementTextFormat{-1}{511 keV}{1/2}{e}{electron}};
   \node[name=M, right of=E, Leptons] {\NaturalElementTextFormat{-1}{105,66 MeV}{1/2}{$\mu$}{muon}};
   \node[name=TA, right of=M, Leptons] {\NaturalElementTextFormat{-1}{1,777 GeV}{1/2}{$\tau$}{tau}};
   
      %% neutrinos
  \node[name=NE, below of=E, Neutrinos] {\NaturalElementTextFormat{0}{$<$2,5 eV}{1/2}{$\nu_e$}{neutrino e}};
   \node[name=NM, below of=M,  Neutrinos] {\NaturalElementTextFormat{0}{$<$170 keV}{1/2}{$\nu_\mu$}{neutrino $\mu$}};
   \node[name=NT, below of=TA, Neutrinos] {\NaturalElementTextFormat{0}{$<$18 MeV}{1/2}{$\nu_\tau$}{neutrino $\tau$}};

   \node[name=TY, right of=T, Empty]{\EmptyNode};
   
         %% bosons
  \node[name=Y, right of=TY, Bosons] {\NaturalElementTextFormat{0}{0}{0}{$\gamma$}{photon}};
   ...
   \node[name=G, below of=Y, Bosons] {\NaturalElementTextFormat{0}{0}{1}{g}{gluon}};
     ...
     \node[name=W, below of=H, Bosons] {\NaturalElementTextFormat{$\pm$1}{80,385$\pm$0,015}{1}{W}{Weak}};
     
     \node[name=W, below of=W, Bosons] {\NaturalElementTextFormat{0}{91,187$\pm$0,002}{1}{Z}{}};
