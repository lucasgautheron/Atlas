...
\fmf{dashes}{i1,v1}
\fmf{photon,left,tension=0.4,label=$W$}{v1,v2,v1}
\fmf{photon}{v2,o1}
\fmf{photon}{v2,o2}
\end{fmfgraph*}
...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) { \includegraphics[width=\textwidth]{../images/figures_AtlasDetectorLabelled.png}};
...
La figure (\ref{fig:atlas_event2}) donne un aperçu d'un évènement vu dans le détecteur. Les \og hits \fg dans les calorimètres sont visbles à l'extérieur du détecteur de traces.

\begin{figure}[H]
\centering
\begin{subfigure}[b]{.5\linewidth}
\centering
  \subcaption{\label{fig:atlas_event}Détecteurs intérieurs} 
\includegraphics[width=0.9\textwidth]{../images/event.jpg}
\end{subfigure}%
\begin{subfigure}[b]{.5\linewidth}
\centering
  \subcaption{\label{fig:atlas_event2}Calorimètres et détecteurs à muons} 
\includegraphics[width=0.9\textwidth]{../images/event2.jpg}
\end{subfigure}
%\centering
 \caption{Vue d'un évènement dans les détecteurs (intérieurs, calorimètres et muoniques).}
%\label{fig:atlas_event2}
%\includegraphics[width=0.6\textwidth]{../images/event2.jpg}
\end{figure}
...
On compare donc (sur des données simulées) le taux d'évènements diphoton reconstruits et passant certains critères de qualité minimum. ('tight')\endnote{Plusieurs niveaux de critères existent, \og tight \fg signifiant des critères plutôt restrictifs comme une énergie minimale de 25 GeV pour des photons}
...
\centering
 ...
 \resizebox{.8\linewidth}{!}{\input{../graphes/acceptance_eta_tight}}
\end{figure}
...
\centering
  \caption{}
 \resizebox{.8\linewidth}{!}{\input{../graphes/acceptance_phi}}
...
\centering
 ...
 \resizebox{.8\linewidth}{!}{\input{../graphes/mgg_medium}}
\end{figure}
...
\centering
 ...
 \resizebox{.8\linewidth}{!}{\input{../graphes/mgg_50GeV}}
\end{figure}
...
%\begin{equation}
%\int L dt = \dfrac{N}{\varepsilon \sigma} = \dfrac{\mbox{586}}{\mbox{0,41} \times \mbox{51} \times \mbox{10} {}^{-15}} = \mbox{28,7} \pm 9,8 \mbox{  fb}{}^{-1}
%\end{equation}
...
\begin{subfigure}[b]{.5\linewidth}
\centering
  \subcaption{\label{fig:higgs_lourds_gg_events} Nombre de Higgs "modèle standard" attendus dans le canal $\gamma\gamma$.  }
 \resizebox{1.1\linewidth}{!}{\input{../graphes/expected_mh}}
\end{subfigure}%
\begin{subfigure}[b]{.5\linewidth}
\centering
  \subcaption{\label{fig:higgs_lourds_gg} Signal/background pour $m_H =$200, 300, 400, 500 et 600 GeV.  }
 \resizebox{1.1\linewidth}{!}{\input{../graphes/higgs_lourds_gg}}
\end{subfigure}
...
\label{fig:pvalue}
 \resizebox{.8\linewidth}{!}{\input{../graphes/pvalue_resonances}}
\end{figure}
...
\label{fig:p0_threshold}
 \resizebox{.8\linewidth}{!}{\input{../graphes/p0_threshold}}
\end{figure}
...
\label{fig:distribution_mee}
 \resizebox{.8\linewidth}{!}{\input{../graphes/mee_sample}}
\end{figure}

On trouve alors $m_Z =$  90,0 $\pm$ 0,8 GeV alors que la valeur attendue est de 91,2 GeV et $\Gamma_Z =$ 2,7 $\pm$ 0,6 GeV à comparer à la valeur théorique $\Gamma_{SM}^2 =$ 2,5 GeV.

%\begin{figure}[H]
%\centering
%\begin{tabular}{|l|c|r|} 
%   \hline
%   Paramètre & Valeur & Meilleure mesure \\
%    \hline
...
Les figures (\ref{fig:mzh_mc}) et (\ref{fig:mzh_data}) montrent les résultats dans le cas de la simulation puis des données. La simulation reproduit bien les prédictions du Modèle Standard\cite{zh_mass}. Les données ne présentent aucun candidat $ZH \to \ell\ell\gamma\gamma$ (évènements noirs moins les évènements rouge), en accord avec ce qui est attendu (0,2 évènement). On note par ailleurs la présence d'un évènement $\ell\ell\gamma\gamma$ d'une masse invariante de 1,1 TeV. 

\begin{figure}[H]
\begin{subfigure}[b]{.5\linewidth}
  \subcaption{Simulation Monte Carlo.}
\label{fig:mzh_mc} 
 \resizebox{1.1\linewidth}{!}{\input{../graphes/mzh_mc}}
\end{subfigure}%
\begin{subfigure}[b]{.5\linewidth}
\raggedright
  \subcaption{Données du Run 1.} 
\label{fig:mzh_data} 
 \resizebox{1.1\linewidth}{!}{\input{../graphes/mzh_data}}
\end{subfigure}
