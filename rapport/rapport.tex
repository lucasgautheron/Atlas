...
\begin{tabular}{|l|c|r|} 
  ...
  \hline
   $\sigma$ & 1,3 GeV & 0,4 GeV \\
  \hline
A & 180 GeV ${}^{-1}$ & 30\\

 \hline
$N = \sqrt{2\pi} \sigma A$ & 586 & 200\\
\hline
\end{tabular}
...
\begin{tabular}{|l|c|r|} 
  ...
  \hline
   $\sigma_Z$ & 2,9 $\pm$ 1,2 GeV & 2,5 GeV \\
 \hline
\end{tabular}

La masse ainsi calculée est correcte. La largeur est bien plus importante que la valeur théorique. On s'attend à une largeur de la forme $\sigma_{exp} \sim \sqrt{(\Delta m_{\gamma \gamma})^2 + \sigma_{SM}^2}$. Les performances de résolution en énergie et directions étant similaires pour les électrons et photons dans le cas $H \to \gamma \gamma$ et $Z\to e^+e^-$, on peut considérer que $\Delta m_{\gamma \gamma} $ vaut environ 1,3 GeV également, donc la valeur de $\sigma_{exp}$ attendue est de 2,8 GeV ce qui est proche de la valeur trouvée (2,9 GeV).
