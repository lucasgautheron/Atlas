...
\label{fig:distribution_mmumu}
 \resizebox{.9\linewidth}{!}{\input{../graphes/mmumu_sample}}
\end{figure}
...
\begin{subfigure}[b]{.5\linewidth}
\centering
  \caption{$ZH$ dans le canal $l^+l^-\gamma\gamma$ (Monte Carlo). Les évènements sont en noir. Les évènements pour lesquels la masse du $Z$ ou du $H$ seul est éloignée de plus de 5 GeV de la masse réelle sont en rouge.}
\label{fig:mzh_mc} 
 \resizebox{1.1\linewidth}{!}{\input{../graphes/mzh_mc}}
\end{subfigure}
\begin{subfigure}[b]{.5\linewidth}
\centering
  \caption{$ZH$ dans le canal $l^+l^-\gamma\gamma$ (Données). Les évènements sont en noir. Les évènements pour lesquels la masse du $Z$ ou du $H$ seul est éloignée de plus de 5 GeV de la masse réelle sont en rouge.} 
\label{fig:mzh_data} 
